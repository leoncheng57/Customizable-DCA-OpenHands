...
// the `prose-ui` typography class in styles.css. If we ever need
 ...
 *
 * Output is wrapped in a `prose-ui` div so the typography rules
...
interface MarkdownProps {
  ...
  source: string;
  /** Optional extra classes appended to the `prose-ui` wrapper. */
  className?: string;
...
export function Markdown({ source, className, untrusted }: MarkdownProps) {
  ...
  return (
    <div
      className={cn("prose-ui", className)}
